...
[Functions]
  ...
  # FIXED: Use proper DRL reward function
  [reward_function]
...
[Reporters]
  [data_reporter]
    ...
    reporters = 'front_location/value front_velocity/value Tinf_pp/value reward/value control_action/value log_prob_action/value temp_left_bc/value'
  []
[]
...
[Controls]
  ...
  [src_control]
    ...
    action_scaling_factors = 90  # ±90°C around 110°C = [20, 200]°C range
