...
[Functions]
  ...
  [distance_reward]
    ...
    observed_value = front_nozzle_distance_tend
    c1 = 1
    c2 = 0.01
  []
...
[Postprocessors]
  # Velocity from DRL-controlled function
  [velocity_pp]
  ...
  # CRITICAL: Need BEGIN and END versions like thermal example
  [front_nozzle_distance_tbegin]
  ...
  [reward]
    ...
    execute_on = 'INITIAL TIMESTEP_END'
    indirect_dependencies = 'front_nozzle_distance_tend'
  []
...
[Reporters]
  [control_reporter]
    ...
    reporters = 'front_nozzle_distance_tend/value front_location/value reward/value velocity_action/value velocity_log_prob/value'
  []
[]
...
[Controls]
  [velocity_control]
    ...
    # CHANGED: Add front_location as second observation
    responses = 'front_nozzle_distance_tbegin front_location'
    
    # CHANGED: Two response normalization values
    response_shift_factors = '0.007 0.001'
    response_scaling_factors = '100 1000'
    
    action_scaling_factors = '0.005'
...
[Outputs]
  [exodus]
    type = Exodus
    file_base = drl_training/sub_output
    execute_on = 'initial final'
  []
  [csv]
    type = CSV
    file_base = drl_training/sub_data
    execute_on = 'initial timestep_end'
  []
[]
