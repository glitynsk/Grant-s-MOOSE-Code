...
[Outputs]
  [exodus]
    type = Exodus
    file_base = constant_speed_1_insulativesubstrate_SingleLayer_out/constant_speed_1_insulativesubstrate_SingleLayer_out
    execute_on = 'initial timestep_end'
    time_step_interval = 10
  []
  [csv]
    type = CSV
    file_base = constant_speed_1_insulativesubstrate_SingleLayer_out/constant_speed_1_insulativesubstrate_SingleLayer_data
    execute_on = 'initial timestep_end'
  []
[]
